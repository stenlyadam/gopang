        ...
        <View style={{
          ...
          marginTop:'4.8%'
            ...
            <Text style={{fontSize:17}}>
              Offering Free Wi-Fi , the owner of this homestay is a head of the village, you will got dinner but not for lunch, if you want a lunch you can ask to owner of the homestay for lunch. and if you have a cars or a motorcycle there's a free parking.
            </Text>
        </View>
      
      {/* Check in/out */}
        <View style={{marginLeft:37,marginTop:22}}>
          <Text style={{marginBottom:6.37,fontSize:14,color:'#38A7D0'}}>Check-in</Text>
          <View style={{
            flexDirection:'row',
            alignItems:'center',
            ...
            />
            <Text style={{fontSize:18,marginLeft:5}}>Sunday, 6 February 2022</Text>
          </View>
          ...
          <View style={{
            ...
            <Image
              ...
              style={{marginLeft:13.18}}
            />
            <Text style={{fontSize:18,marginLeft:5}}>Monday, 7 February 2022</Text>
          </View>
          <Text style={{fontSize:12}}>Max.31 Days</Text>
          <Text style={{fontSize:18,marginTop:7.34}}>1 Malam</Text>

          <View style={{flexDirection:'row',marginTop:21.68,marginBottom:34.65,height:57.35,alignItems:'center'}}>
            <Text style={{color: '#38A7D0', fontWeight: 'bold',fontSize:20}}>
              IDR 200.000
            </Text>
            <Text style={{fontWeight: 'bold',fontSize:12,marginTop:7}}>/Night</Text>
