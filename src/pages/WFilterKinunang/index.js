...
const WFilterKinunang = ({navigation, route}) => {
    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      {search.length === 0 ? (
              <View>
                <View>
                  {onWarung
                    .filter(warung => warung.alamat.includes(locationKinunang)&&
              ...
              onWarung
                .filter(
                  warung => warung.alamat.includes(locationKinunang)&&
...
export default WFilterKinunang;
