...
const WFilterPulisan = ({navigation, route}) => {
    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      {search.length === 0 ? (
              <View>
                <View>
                  {onWarung
                    .filter(warung => warung.alamat.includes(locationPulisan)&&
              ...
              onWarung
                .filter(
                  warung => warung.alamat.includes(locationPulisan)&&
