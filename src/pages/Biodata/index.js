  ...
  return (
    ...
    <View style={{flex:1}}>
        ...
        <View style={{flex:1}}>
          ...
          {/* Input Information */}
          <View>
              <Text style={{fontSize:13,color:'#555555',marginLeft:46,marginTop:23}}>First name</Text>
              ...
              <Text style={{fontSize:13,color:'#555555',marginLeft:46,marginTop:23}}>Last name</Text>
              <View style={{alignItems:'center'}}>
                <Input 
              ...
              <Text style={{fontSize:13,color:'#555555',marginLeft:46,marginTop:23}}>Email</Text>
              <View style={{alignItems:'center'}}>
                <Input 
                placeholder={'Email'} 
                type={text} 
              ...
              <Text style={{fontSize:13,color:'#555555',marginLeft:46,marginTop:23}}>Mobile Phone</Text>
              <View style={{alignItems:'center'}}>
                <Input 
