...
const TotalFood = () => {
  return (
    <View>
      <Header onBack={() => navigation.navigate('Charts')} />
      <View style={styles.garis1} />

      <Text style={styles.order}>Orders</Text>

      {/* Food 1 */}
      <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:28, marginTop:21}}>
      ...
      {/* Drink 1 */}
      <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:28, marginTop:3}}>
        <View style={{flexDirection:'row'}}>
          <View>
      ...
      <View style={{flexDirection:'row',paddingHorizontal:27, marginTop:5}}>
        ...
        <View><Text style={{fontSize:18,marginLeft:70, width:85, height:65}}>COD(Cash on Delivery)</Text></View>
      </View>
        <View style={styles.garis} />
      ...
      <View style={styles.garis2} />
        <View style={{flexDirection:'row'}}>
          <View>
          <Text style={{fontSize:18, marginLeft:35,marginTop:20}}>Total</Text>
          </View>
          <View>
          <Text style={{fontSize:22,fontWeight: "bold", marginLeft:10,marginTop:16}}>Rp 31.000,-</Text>
          </View>
          <ButtonOrder/>
        </View>
    </View>
