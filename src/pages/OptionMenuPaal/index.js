    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView style={{flex: 1}} showsVerticalScrollIndicator={false}>
        ...
        <View style={{marginLeft: 20, marginBottom: 27}}>
          ...
          <View style={styles.GaleryPhotos}>
            <ScrollView
              ...
              <Image
                style={styles.Photos1}
                source={require('../../assets/pantai/Paal/Paal1.png')}
              />
              <Image
                style={styles.Photos}
                source={require('../../assets/pantai/Paal/Paal2.png')}
              />
              <Image
                style={styles.Photos}
                source={require('../../assets/pantai/Paal/Paal3.png')}
              />
              <Image
                style={styles.Photos}
                source={require('../../assets/pantai/Paal/Paal4.png')}
        ...
        <View style={{alignSelf: 'center', marginBottom: 19.27}}>
          <OpenURLButton url={supportedURL} btnView={styles.btnView}>
            Get Directions
          </OpenURLButton>
        </View>
      </ScrollView>
