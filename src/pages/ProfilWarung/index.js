...
const ProfilWarung = ({navigation}) => {
  ...
  return (
    <View>
      <Header onBack={() => navigation.navigate('MenuFood')} onCharts={()=> navigation.navigate('Charts')}  />
      ...
      <View style={{flexDirection: 'row', marginLeft: 31, marginTop: 6,}}>
        ...
        <Text style={{marginLeft: 13, fontSize: 14}}>30 Minute Delivery Time</Text>
      </View>


      {/* Popular Items */}
      <Text style={{fontSize: 15, marginLeft: 31,marginTop:27,}}>Popular Items</Text>
